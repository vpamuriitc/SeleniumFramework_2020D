...
import cloud.components.AP.SupplierMergeandThirdPartyPaymentsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate_More;
import itc.framework.BaseTest;


public class SupplierMergeandThirdPartyPaymentsITC_Test extends BaseTest{
		...
		public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
			...
			Login.run(1);
			Navigate_More.run(1);
			SupplierMergeandThirdPartyPaymentsITC.run(1);
		}
		@AfterTest
		public void end(){
			//close();
