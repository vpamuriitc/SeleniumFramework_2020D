...
import cloud.components.HCM_Old.CreatingWorkRelationshipsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class CreatingWorkRelationshipsITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		CreatingWorkRelationshipsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
