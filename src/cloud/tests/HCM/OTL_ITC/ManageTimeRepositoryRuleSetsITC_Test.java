...
import cloud.components.OTL.ManageTimeRepositoryRuleSetsITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class ManageTimeRepositoryRuleSetsITC_Test extends BaseTest{
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		ManageTimeRepositoryRuleSetsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
