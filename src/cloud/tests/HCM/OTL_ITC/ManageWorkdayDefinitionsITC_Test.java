...
import cloud.components.OTL.ManageWorkdayDefinitionsITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class ManageWorkdayDefinitionsITC_Test extends BaseTest{
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		ManageWorkdayDefinitionsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
