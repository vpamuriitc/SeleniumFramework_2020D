...
import cloud.components.MigFA.AssetAdjustmentandTrackingITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class AssetAdjustmentandTrackingITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		//Navigate_More.run(1);
		AssetAdjustmentandTrackingITC.run(1);
	}
	@AfterTest
	public void end(){
		//close();
